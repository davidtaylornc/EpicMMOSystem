...
namespace EpicMMOSystem
{
    ...
    public static class TerminalCommands
    {
        ...
        private static void RPC_SetLevel(long sender, int level)
        {
            ...
            Chat.instance.RPC_ChatMessage(200, Vector3.zero, 0, local["$notify"], String.Format(local["$terminal_set_level"], level),sender.ToString());
        }
        ...
        private static void RPC_ResetPoints(long sender)
        {
            ...
            Chat.instance.RPC_ChatMessage(200, Vector3.zero, 0, local["$notify"], local["$terminal_reset_points"], sender.ToString());
        }
